...
export default {
  ...
  methods: {
    ...
    likePost() {
      ...
      axios({
        method: "POST",
        url: `carolinep13-groupomania.herokuapp.com/api/posts/vote-post`,
        data: body,
        headers: {
    ...
    getThisPostsVotes() {
      ...
      axios({
        method: "GET",
        url: `carolinep13-groupomania.herokuapp.com/api/posts/all-votes-post/${PostId}`,
    ...
    getOneVote() {
      ...
      axios({
        method: "GET",
        url: `carolinep13-groupomania.herokuapp.com/api/posts/one-vote/${id}`,
    ...
    unlikePost() {
      ...
      axios({
        method: "DELETE",
        url: `carolinep13-groupomania.herokuapp.com/api/posts/vote-post/${id}`,
    ...
    getAllComments() {
      ...
      axios({
        method: "GET",
        url: `carolinep13-groupomania.herokuapp.com/api/comments/posts/${this.postId}`,
